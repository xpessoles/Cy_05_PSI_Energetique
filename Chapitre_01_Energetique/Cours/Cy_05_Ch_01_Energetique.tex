...
\begin{itemize}
\item avec \textbf{son inertie équivalente $J_{\text{eq}}(E)$} (en $kg\cdot m^2$) rapportée à un paramètre de rotation $\dot{\theta}(t)$ : 
$$
E_c(E/R_g)=\frac{1}{2}J_{\text{eq}}(E)\cdot \dot{\theta}^2.
$$
\item avec \textbf{sa masse équivalente $M_{\text{eq}}(E)$} (en $kg$) rapportée à un paramètre de translation $\dot{x}(t)$ : 
$$
