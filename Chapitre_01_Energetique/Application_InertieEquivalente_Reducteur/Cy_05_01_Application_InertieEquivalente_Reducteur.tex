...
\def\xxtitreexo{Application -- Détermination de l'inertie équivalente de réducteurs}%Motorisation du moteur Haibike}
...
\subparagraph{}
\textit{Déterminer le couple nécessaire à la mise en mouvement de la charge sur l'arbre de sortie. }
