...
\subparagraph{}\textit{Construire le graph des liaisons modélisant le système entier.}
...
\end{align*}
\begin{itemize}
\item $\mathcal{P}(S_0 \rightarrow S_1/R_0)$ : 

\begin{align*}
\mathcal{P}(S_0 \rightarrow S_1/R_0)=\torseurstat{T}{S_0}{S_1}\otimes \torseurcin{V}{S_1}{R_0}
=\torseurl{O_0}{X_{01}\cdot \overrightarrow{x_0}+Y_{01}\cdot \overrightarrow{y_0}+Z_{01}\cdot \overrightarrow{z_0}}{L_{01}\cdot \overrightarrow{x_0} \pm C_r\cdot \overrightarrow{y_0}+N_{01}\cdot \overrightarrow{z_0}}
\otimes
\torseurl{O_0}{\dot{\theta}(t)\cdot \overrightarrow{y_0}}{\overrightarrow{0}}\\
=\pm C_r\cdot \dot{\theta}(t)
\end{align*}

Le signe de la composante suivant $\overrightarrow{y_0}$ dépendra du sens du mouvement de $S_1/S_0$
\item $\mathcal{P}(\text{Moteur} \rightarrow S_1/R_0)$ : 

\begin{align*}
\mathcal{P}(S_0 \rightarrow S_1/R_0)=\torseurstat{T}{\text{Moteur}}{S_1}\otimes \torseurcin{V}{S_1}{R_0}
...
=\torseurl{-}{X_{03}\cdot \overrightarrow{x}_0\pm Y_{03}\cdot \overrightarrow{y}_0+Z_{03}\cdot \overrightarrow{z_0}}{L_{03}\cdot \overrightarrow{x}_0 + M_{03}\cdot \overrightarrow{y}_0+N_{03}\cdot \overrightarrow{z_0}}
\otimes
\torseurl{-}{\overrightarrow{0}}{\dot{y}(t)\cdot \overrightarrow{y_0}}\\
=\pm Y_{03}\cdot \dot{y}(t)
\end{align*}

\item $\mathcal{P}(poids \rightarrow S_3/R_0)$ : 
...
\otimes
\torseurl{G_3}{\overrightarrow{0}}{\dot{y}(t)\cdot \overrightarrow{y_0}}\\
=0
\end{align*}
\end{itemize}
\item $\mathcal{P}(\text{ext}\rightarrow E/R_0)$ : 
