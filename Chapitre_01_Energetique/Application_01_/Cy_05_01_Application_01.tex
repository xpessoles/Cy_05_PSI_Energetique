...
\def\xxsourceexo{\hspace{.2cm} \footnotesize{Pôle Chateaubraind -- Joliot-Curie}}
...
\def\xxauteur{\textsl{Pôle Chateaubraind -- Joliot-Curie}}
...
\item la relation entre $\omega_{21}$ et $u_{31}$ la vitesse de déplacement du vantail 3 par rapport au bâti 1.
\end{itemize}}
\ifprof
\begin{corrige}
\end{corrige}\else\fi
